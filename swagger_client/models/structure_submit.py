...
class StructureSubmit(object):
    ...
    swagger_types = {
        'ticker': 'str',
        'values': 'list[SubmitStructureElement]',
        'speed_type': 'str'
    }
    ...
    def __init__(self, ticker=None, values=None, speed_type=None):  # noqa: E501
        """StructureSubmit - a model defined in Swagger"""  # noqa: E501
        self._ticker = None
        self._values = None
    ...
    @property
    def ticker(self):
        """Gets the ticker of this StructureSubmit.  # noqa: E501


        :return: The ticker of this StructureSubmit.  # noqa: E501
        :rtype: str
        """
        return self._ticker
    ...
    def ticker(self, ticker):
        """Sets the ticker of this StructureSubmit.


        :param ticker: The ticker of this StructureSubmit.  # noqa: E501
        :type: str
        """
    ...
    @property
    def values(self):
        """Gets the values of this StructureSubmit.  # noqa: E501


        :return: The values of this StructureSubmit.  # noqa: E501
        :rtype: list[SubmitStructureElement]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this StructureSubmit.


        :param values: The values of this StructureSubmit.  # noqa: E501
        :type: list[SubmitStructureElement]
        """
    ...
    @property
    def speed_type(self):
        """Gets the speed_type of this StructureSubmit.  # noqa: E501


        :return: The speed_type of this StructureSubmit.  # noqa: E501
        :rtype: str
        """
    ...
    def speed_type(self, speed_type):
        """Sets the speed_type of this StructureSubmit.


        :param speed_type: The speed_type of this StructureSubmit.  # noqa: E501
        :type: str
        """
        allowed_values = ["SLOW", "MEDIUM", "FAST"]  # noqa: E501
        if speed_type not in allowed_values:
            raise ValueError(
                "Invalid value for `speed_type` ({0}), must be one of {1}"  # noqa: E501
                .format(speed_type, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StructureSubmit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StructureSubmit):
            return False
