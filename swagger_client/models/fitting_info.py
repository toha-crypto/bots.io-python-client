...
class FittingInfo(object):
    ...
    swagger_types = {
        ...
        'percent_fitted': 'float',
        'fitted_per_asset': 'dict(str, float)'
    }

    attribute_map = {
        'rebalance_completed': 'rebalanceCompleted',
        'percent_fitted': 'percentFitted',
        'fitted_per_asset': 'fittedPerAsset'
    }

    def __init__(self, rebalance_completed=None, percent_fitted=None, fitted_per_asset=None):  # noqa: E501
        """FittingInfo - a model defined in Swagger"""  # noqa: E501
        self._rebalance_completed = None
        self._percent_fitted = None
        self._fitted_per_asset = None
        self.discriminator = None
        if rebalance_completed is not None:
            self.rebalance_completed = rebalance_completed
        if percent_fitted is not None:
            self.percent_fitted = percent_fitted
        if fitted_per_asset is not None:
            self.fitted_per_asset = fitted_per_asset

    @property
    def rebalance_completed(self):
        """Gets the rebalance_completed of this FittingInfo.  # noqa: E501


        :return: The rebalance_completed of this FittingInfo.  # noqa: E501
        :rtype: bool
        """
        return self._rebalance_completed

    @rebalance_completed.setter
    def rebalance_completed(self, rebalance_completed):
        """Sets the rebalance_completed of this FittingInfo.


        :param rebalance_completed: The rebalance_completed of this FittingInfo.  # noqa: E501
        :type: bool
        """

        self._rebalance_completed = rebalance_completed

    @property
    def percent_fitted(self):
        """Gets the percent_fitted of this FittingInfo.  # noqa: E501


        :return: The percent_fitted of this FittingInfo.  # noqa: E501
        :rtype: float
        """
        return self._percent_fitted

    @percent_fitted.setter
    def percent_fitted(self, percent_fitted):
        """Sets the percent_fitted of this FittingInfo.


        :param percent_fitted: The percent_fitted of this FittingInfo.  # noqa: E501
        :type: float
        """

        self._percent_fitted = percent_fitted

    @property
    def fitted_per_asset(self):
        """Gets the fitted_per_asset of this FittingInfo.  # noqa: E501


        :return: The fitted_per_asset of this FittingInfo.  # noqa: E501
        :rtype: dict(str, float)
        """
        return self._fitted_per_asset

    @fitted_per_asset.setter
    def fitted_per_asset(self, fitted_per_asset):
        """Sets the fitted_per_asset of this FittingInfo.


        :param fitted_per_asset: The fitted_per_asset of this FittingInfo.  # noqa: E501
        :type: dict(str, float)
        """

        self._fitted_per_asset = fitted_per_asset
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FittingInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FittingInfo):
            return False
