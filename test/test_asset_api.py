...
class TestAssetApi(unittest.TestCase):
    ...
    def test_asset_statistics(self):
        """Test case for asset_statistics

        Statistics  # noqa: E501
        """
        pass

    def test_asset_ticker(self):
        """Test case for asset_ticker
