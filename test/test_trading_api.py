...
from swagger_client.api.trading_api import TradingApi  # noqa: E501
...
class TestTradingApi(unittest.TestCase):
    ...
    def test_order_offer(self):
        """Test case for order_offer

        Trade offer  # noqa: E501
        """
        pass

    def test_order_trade(self):
        """Test case for order_trade
